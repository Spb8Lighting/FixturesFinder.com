...
$Changelog = array(
	...
	'2017-12-10' => array(
					...
					'UPDATED|Update "Search for similar" icon from the fixture page 🔗 <em>(harmonisation)</em>"',
	...
	'2017-03-30' => array(
					...
					'FIXED|<a href="./'._Synchro_.'">Status page</a> was provided bad analysis summary',
	...
	'2017-01-26' => array(
					...
					'ADDED|<a href="./'._Changelog_.'">Changelog page</a> which described almost all stuff done as far as my memory allow me to 😂',
